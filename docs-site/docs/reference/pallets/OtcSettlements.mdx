---
title: OtcSettlements
description: Runtime pallet documentation
sidebar_label: OtcSettlements
---
...
**Pallet #72** · HydraDX<br/>
`pallet-otc-settlements/4ca470c5/master`

[GitHub](https://github.com/galacticcouncil/HydraDX-node/tree/4ca470c5d613d62ce52eb8645770ef5fff263111/pallets/otc-settlements) · [Subscan](https://hydradx.subscan.io/runtime/OtcSettlements)
...
```rust
const MinProfitPercentage: Perbill
```
