---
title: XYKWarehouseLM
description: Runtime pallet documentation
sidebar_label: XYKWarehouseLM
---
...
**Pallet #96** · HydraDX<br/>
`warehouse-liquidity-mining/4ca470c5/master` (Instance2)

[GitHub](https://github.com/galacticcouncil/HydraDX-node/tree/4ca470c5d613d62ce52eb8645770ef5fff263111/pallets/liquidity-mining) · [Subscan](https://hydradx.subscan.io/runtime/XYKWarehouseLM)
...
**Read by SDK:** [LiquidityMiningClient.getIsolatedGlobalFarm](/reference/sdk/sdk-next#liquidityminingclient)
...
```rust
YieldFarm: Map<(AccountId32,u32,u32) -> {
    id: u32,
    updatedAt: u32,
    totalShares: u128,
...
**Read by SDK:** [LiquidityMiningClient.getIsolatedYieldFarm](/reference/sdk/sdk-next#liquidityminingclient)
...
**Read by SDK:** [LiquidityMiningClient.getAllIsolatedFarms](/reference/sdk/sdk-next#liquidityminingclient), [LiquidityMiningClient.getIsolatedFarms](/reference/sdk/sdk-next#liquidityminingclient)
